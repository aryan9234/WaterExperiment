...
public class WaterExperiment extends InputAdapter implements ApplicationListener {
	...
	String fragmentShader = "#ifdef GL_ES\n"
			...
			+ "  float t=v_texCoords.y +displacement.y*0.1-0.15+  (sin(v_texCoords.x * frequency+timedelta) * amplitude); \n" //
	...
	float amplitude=.02f,frequency=60.0f;
	...
	public void render() {
		...
		shader.setUniformf("amplitude",amplitude);
		shader.setUniformf("frequency",frequency);
